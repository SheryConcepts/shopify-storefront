...
// This Array contain the data of all the six cards of Blog Page , i.e : data of firstThreeCards and secondThreeCards
export const allSixCards = [
  ...firstThreeCards,
  ...secondThreeCards
]
